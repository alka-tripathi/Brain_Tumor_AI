 ...
 * Make sure you have included the OpenCV script in your Next.js app, e.g.:
 ...
 * 
 * @param {HTMLImageElement} imageElement - The image element containing the uploaded MRI scan
 * @param {HTMLCanvasElement} canvasElement - The canvas element to draw the processed image on
 */
export const processMRIImage = async (imageElement, canvasElement) => {
  try {
